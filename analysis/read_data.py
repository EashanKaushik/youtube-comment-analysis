    ...
    if mr_beast:
        ...
        for current_dir in os.listdir('mr_beast'):
            if mr_beast_df is not None:
                mr_beast_df = pd.concat([mr_beast_df, pd.read_csv(os.path.join('mr_beast', current_dir))])
            else:
                mr_beast_df = pd.read_csv(os.path.join('mr_beast', current_dir))
    ...
    if mr_beast_gaming:
        ...
        for current_dir in os.listdir('mr_beast_gaming'):
            if mr_beast_gaming_df is not None:
                mr_beast_gaming_df = pd.concat([mr_beast_gaming_df, pd.read_csv(os.path.join('mr_beast_gaming', current_dir))])
            else:
                mr_beast_gaming_df = pd.read_csv(os.path.join('mr_beast_gaming', current_dir))
